...
class wpdb {
	...
	function select( $db, $dbh = null) {
		...
		if ( !@mysql_select_db( $db, $dbh ) ) {
			$this->ready = false;
			$this->bail( sprintf( /*WP_I18N_DB_SELECT_DB*/'<h1>Impossibile selezionare il database</h1>
...
<p>Se non si sa come impostare un database sarebbe opportuno <strong>contattare il proprio fornitore di hosting</strong>. Se tutto questo fallisce è possibile trovare aiuto sul <a href=\'http://www.wordpress-it.it/forumt/\'>Forum di supporto italiano su WordPress</a>.</p>'/*/WP_I18N_DB_SELECT_DB*/, $db, $this->dbuser ), 'db_select_fail' );
			return;
		}
	}
