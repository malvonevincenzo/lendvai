...
// $base sanity check.
if ( 'BASE' == $base )
	die( /*WP_I18N_BASE_ERROR*/'Errore di configurazione in <code>wp-config.php</code>. <code>$base</code> è impostata a <code>BASE</code> quando dovrebbe essere <code>/</code> oppure <code>/blogs/</code>.'/*/WP_I18N_BASE_ERROR*/ );
...
if ( !isset( $current_site ) || !isset( $current_blog ) ) {
	...
	if ( false !== strpos( $domain, ':' ) ) {
		if ( substr( $domain, -3 ) == ':80' ) {
			...
			wp_die( /*WP_I18N_NO_PORT_NUMBER*/'La modalità multisito funziano solo senza il numero di porta nella URL.'/*/WP_I18N_NO_PORT_NUMBER*/ );
		}
	}
	...
	if ( ! $blog_id ) {
		if ( defined( 'WP_INSTALLING' ) ) {
			...
			$msg = ! $wpdb->get_var( "SHOW TABLES LIKE '$wpdb->site'" ) ? ' ' . /*WP_I18N_TABLES_MISSING*/'Tabelle del database mancanti.'/*/WP_I18N_TABLES_MISSING*/ : '';
			wp_die( /*WP_I18N_NO_BLOG*/'Nessun sito con questo nome su questo sistema.'/*/WP_I18N_NO_BLOG*/ . $msg );
		}
	}
}
